...
const pageGuides = [
  ...
  },
  {
    ...
    businessValue: '将数据分析能力民主化——让每个业务人员都能像分析师一样思考和决策',
    keyInsights: [
      { title: 'AI评论分析准确率87%，人工复核一致率92%', desc: 'AI分析已可替代80%的人工评论分析工作，释放人力聚焦深度洞察', type: 'efficiency' },
      { title: '知识库覆盖1500+条行业知识，响应<2秒', desc: '内部知识沉淀和共享效率提升10倍', type: 'efficiency' },
      { title: '设计助手月均生成200+张参考图', desc: '概念验证周期从2周缩短至2天，加速产品迭代', type: 'efficiency' }
    ],
  ...
  },
  {
    ...
    businessValue: '替代外部产品拍摄和设计外包，预估节省设计成本$256K/年',
    keyInsights: [
      { title: '145张AI图覆盖9个品类', desc: '从吸奶器到孕妇枕的全品类视觉资产库', type: 'asset' },
