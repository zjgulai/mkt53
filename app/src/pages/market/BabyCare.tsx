...
export default function BabyCare() {
  const {
    ...
    evidence: babyCareEvidence,
    eligibleEvidence: eligibleBabyCareEvidence,
    safety: { businessDataWrites: babyCareEvidenceBusinessDataWrites, networkCalls: babyCareEvidenceNetworkCalls },
    statusLabel: babyCareEvidenceStatusLabel,
  } = usePublicEvidence('ds-037', 'BabyCare');
      ...
      internalFactSummary={
        <div className="rounded-xl border border-[#EDE6DF] bg-[#FBF8F5] p-3">
          <div className="flex items-start justify-between gap-3 flex-wrap">
            ...
            <span className={`inline-flex rounded-lg px-3 py-1.5 text-[10px] font-medium ${eligibleBabyCareEvidence.length > 0 ? 'bg-[#5B8C5A]/10 text-[#5B8C5A]' : 'bg-[#C44545]/10 text-[#C44545]'}`}>
