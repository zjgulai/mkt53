...
// ─── 渠道销售表现 ───
// audit-source: ds-041; sample-only; 待复核; canDisplayAsFact=false
...
const interviews = [
  {
    ...
    rating: 5, date: '样例访谈窗口：待接入（示例）', duration: '55min', method: '视频会议+数据看板共享',
  },
  {
    ...
    rating: 4, date: '样例访谈窗口：待接入（示例）', duration: '48min', method: '面对面访谈+门店走访',
  },
  {
    ...
    rating: 4, date: '样例访谈窗口：待接入（示例）', duration: '52min', method: '视频会议+后台数据演示',
  },
  {
    ...
    rating: 5, date: '样例访谈窗口：待接入（示例）', duration: '60min', method: '面对面访谈+GA4数据分析',
  },
  {
    ...
    rating: 4, date: '样例访谈窗口：待接入（示例）', duration: '50min', method: '视频会议+区域数据报告',
  },
  {
    ...
    rating: 4, date: '样例访谈窗口：待接入（示例）', duration: '45min', method: '视频会议+竞品对比分析',
  },
];
    ...
    <div className="min-h-screen pt-20 pb-12 px-4 sm:px-6 lg:px-8">
      ...
      'channel_interviews.csv'
            ...
            <InterviewAgents
              ...
              regions={['美国', '英国', '新加坡']}
              dateRange="样例访谈窗口：待接入（示例） · 待销售快照复核"
            />
