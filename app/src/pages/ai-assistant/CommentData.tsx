...
const stats = [{"label":"评论总数","value":"45,280"},{"label":"覆盖平台","value":"8"},{"label":"五星好评率","value":"78%"},{"label":"日新增","value":"320"}];

const features = ["Amazon/官网/社交媒体评论聚合","评论时间分布与趋势分析","用户画像与评论关联分析","负面评论自动预警与分类","评论关键词云与主题挖掘"];
