...
const allReports: Report[] = [
  // 区域宏观分析
  { id: 'r001', title: '2026年Q1全球母婴市场宏观洞察报告', category: '区域宏观分析', date: '2026-05-23', author: '市场研究团队', pages: 68, downloads: 342, isStarred: true, status: '最新', summary: '覆盖北美/欧洲/亚太/中东/拉美5大区域，TAM/SAM/SOM三级市场规模测算，PEST分析+波特五力模型', tags: ['TAM测算', 'PEST', '波特五力'] },
  ...
  // 新品/技术监测
  { id: 'r005', title: '2026年Q1母婴行业新品上市监测报告', category: '新品/技术监测', date: '2026-04-20', author: '产品监测组', pages: 45, downloads: 456, isStarred: true, status: '最新', summary: '2026年Q1全球15款新品追踪，Momcozy W1加热款/Medela Melody InBra/Willow Sync技术参数对比', tags: ['新品追踪', '技术参数', '发布日历'] },
  ...
  // 竞品情报
  { id: 'r009', title: '2026年Q1全球吸奶器市场竞争格局报告', category: '竞品情报', date: '2026-04-12', author: '竞争分析组', pages: 78, downloads: 623, isStarred: true, status: '最新', summary: '8大品牌25款产品Amazon实时数据采集，价格带竞争地图，BCG矩阵分析', tags: ['竞争格局', '价格地图', 'BCG矩阵'] },
  ...
  // 拆机报告
  { id: 'r013', title: 'Momcozy W1 加热款穿戴式吸奶器拆解与BOM成本分析', category: '拆机报告', date: '2026-05-23', author: '拆解分析组', pages: 52, downloads: 445, isStarred: true, status: '最新', summary: '内置加热膜/隔膜泵/主控芯片3大核心模块拆解，BOM成本$38.6，vs eufy HeatFlow/Medela FluidFeel对标', tags: ['BOM成本', '核心模块', '对标分析'] },
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            ...
            { label: '本月新增', value: '4', icon: <TrendingUp className="w-4 h-4" />, color: '#5856d6' },
          ].map((s, i) => (
        ...
        <div className="bg-gradient-to-r from-[#C25B6E]/5 to-[#FBF8F5] rounded-2xl p-5 card-shadow-sm border border-[#C25B6E]/15 mb-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-[#C25B6E]">本月必读 TOP3</h3>
            <span className="text-[10px] text-[#86868b] bg-white/60 px-2 py-0.5 rounded-full ml-auto">编辑精选</span>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {[
              { title: 'Momcozy vs Medela vs Willow 品牌竞争力深度对比', category: '竞品情报', value: '战略决策必读：8维雷达+SWOT+价格地图，CEO/产品负责人必读', pages: 92, downloads: 891 },
              { title: '2026年Q1全球吸奶器市场竞争格局报告', category: '竞品情报', value: '市场全景：8品牌25款产品实时数据，市场团队季度规划参考', pages: 78, downloads: 623 },
              { title: 'Momcozy W1 加热款拆解与BOM成本分析', category: '拆机报告', value: '产品深度：BOM $38.6，供应链团队成本优化参考', pages: 52, downloads: 445 },
            ].map((r, i) => (
              <div key={i} className="p-3 rounded-xl bg-white/70 border border-[#EDE6DF] cursor-pointer hover:border-[#C25B6E]/30 transition-all" onClick={() => navigate('/report/r010')}>
        ...
        {/* R29: 推荐阅读顺序 */}
        <div className="flex items-center gap-3 mb-6 p-3 rounded-xl bg-[#FBF8F5] border border-[#EDE6DF]">
          ...
          <span className="text-[9px] text-[#B5AFA8] ml-auto">由广到深 · 先市场后产品</span>
        </div>
        ...
        {/* R30: 报告订阅提示 */}
        <div className="mt-6 p-4 rounded-2xl bg-gradient-to-r from-[#C25B6E]/5 to-[#FBF8F5] border border-[#C25B6E]/15 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-[10px] text-[#86868b]">每周精选2-3份新报告推送，覆盖竞品动态、政策变化、技术趋势</p>
          </div>
          <button className="px-4 py-2 rounded-xl bg-[#C25B6E] text-white text-xs font-medium hover:bg-[#A34759] transition-colors duration-200">立即订阅</button>
        </div>
      </div>
    </div>
  );
