...
// ── 六类完整用户画像 ──
// R16: 画像添加优先级和行动建议
// audit-source: ds-011 ds-043; public-context; 已复核; 画像线索
const personaTable = [
...
// audit-source: ds-043; public-context; 已复核
const incomeData = [
...
// audit-source: ds-012; sample-only; 待复核; canDisplayAsFact=false
const rfmData = [
...
export default function UsersPage() {
  ...
  const init = getStateForPath(location.pathname);
    ...
    <div className="space-y-6">
      {activeChild === '消费者访谈' && (
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {/* audit-source: ds-014; sample-only; 待复核; canDisplayAsFact=false */}
            {[
      ...
      {activeChild === '店铺访谈' && (
        <div className="space-y-5">
          {/* KPI摘要 */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {/* audit-source: ds-042; sample-only; 待复核; canDisplayAsFact=false */}
            {[
  ...
  const renderRegionalPersona = () => (
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-5 card-shadow-sm border border-[#EDE6DF]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* audit-source: ds-011; public-context; 已复核 */}
          <div>
