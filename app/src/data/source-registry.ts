...
export const sourceRegistry = [
  ...
  { id: 'ds-043', module: '看用户', page: 'UsersPage', metric: '海外母乳喂养动机与场景', sourceName: 'Mamava / Medela 2025 State of Breastfeeding Survey', sourceType: '行业调研', year: '2025', reliability: 'B', verificationStatus: 'needs-review', lastVerified: '2026-06-02', note: 'Mamava/Medela调研可支撑海外母乳喂养动机和场景，不应与QuestMobile中国移动互联网画像合并为同一口径。', gap: '需要补样本量、调查时间、地域和题目口径', action: '在用户画像页拆分海外调研与中国移动互联网画像', sourceUrl: 'https://www.mamava.com/why-buy-blog/2025-state-of-breastfeeding-survey' },
  ...
  { id: 'ds-034', module: '看行业', page: 'IndustryNews', metric: '母婴行业资讯', sourceName: 'FDA/CPSC/EU/品牌官网/新闻源手工汇编', sourceType: '新闻', year: '2024-2026', reliability: 'B', verificationStatus: 'needs-review', lastVerified: '2026-06-02', note: '资讯列表需要逐条补原文URL和发布日期复核，不能把汇编列表整体视为已复核事实。', gap: '缺少条目级sourceUrl和复核状态', action: '拆分为新闻条目级registry或采集manifest' },
